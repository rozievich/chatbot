...
class UserChatConsumer(WebsocketConsumer):
    ...
    def chat_message(self, event):
        ...
        self.send(text_data=json.dumps({"receiver": receiver, "sender": sender, "message": message, "created_at": created_at}))
    ...
    def _send_message_to_channel(self, message_text, receiver_user):
        ...
        async_to_sync(self.channel_layer.group_send)(
            self.user_chat_name,
            {"type": "chat.message", "message": message_text, "sender": self.sender_user.username, "receiver": receiver_user.username}
        )
